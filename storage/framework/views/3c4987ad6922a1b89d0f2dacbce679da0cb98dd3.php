    ...
    <div class="col-md-4 col-sm-6">
        <div class="iq-pricing">
            ...
            <div class="pricing-header">
                ...
                <span class="price-value"><?php echo e($plan->increment_amount); ?>%</span>
            </div>
            <ul class="pricing-content">
                <li><i aria-hidden="true" class="iq-mr-10 ion-checkmark-round"></i>Min: <?php echo e($settings->currency); ?><?php echo e($plan->min_price); ?></li>
                <li><i aria-hidden="true" class="iq-mr-10 ion-checkmark-round"></i>Max: <?php echo e($settings->currency); ?><?php echo e($plan->max_price); ?></li>
                <li><i aria-hidden="true" class="iq-mr-10 ion-checkmark-round"></i><?php echo e($settings->currency); ?><?php echo e($plan->gift); ?> Gift Bonus</li>
