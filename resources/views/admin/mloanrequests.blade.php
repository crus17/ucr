								...
								<table id="ShipTable" class="table table-hover text-{{$text}}"> 
									...
									<tbody> 
										...
										<tr> 
											...
											@else
											<a class="btn btn-success btn-sm m-1" href="{{ url('admin/dashboard/processloan') }}/{{$loan->id}}/yes">Approve</a>
											<a class="btn btn-danger btn-sm m-1" href="{{ url('admin/dashboard/processloan') }}/{{$loan->id}}/no">Reject</a>
											@endif
											<!--<a href="#" class="btn btn-info btn-sm m-1" data-toggle="modal" data-target="#viewModal{{$loan->id}}"><i class="fa fa-eye"></i> View</a>-->
											</td> 
										</tr> 
